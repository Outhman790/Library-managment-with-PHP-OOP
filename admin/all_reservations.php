            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <section class="text-center">
                    ...
                    <div class="row">
                        ...
                        $allReservations = $AllReservationsObj->getAllReservations();
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                <div class="card">
                                    ...
                                    <div>
                                        ...
                                        <button type="button" class="btn btn-primary my-2" data-bs-toggle="modal" data-bs-target="#confirmationModal<?php echo $value['Collection_ID'] ?>">
                                            Confirm
                                        </button>
                                        <!-- Reserve Modal -->
                                        <div class="modal fade" id="confirmationModal<?php echo $value['Collection_ID'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button"> <a class="btn btn-primary" href="../includes/confirmReservation.inc.php?id=<?php echo $value['Reservation_ID'] ?>">Confirm</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
